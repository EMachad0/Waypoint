...
ADRs live in `docs/adr/` and use sequential numbering: `0001-slug.md`, `0002-slug.md`, etc. The
directory already exists and is tracked, so a new ADR is a new file in it.
